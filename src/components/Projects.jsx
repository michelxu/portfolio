...
const Projects = () => {
  return (
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 w-full mb-8 gap-4'>
      {/* KUMITE MMA */}
      <div className='flex flex-col gap-2 pb-4 mb-4 w-full bg-gray-200 rounded-md border border-gray-300'>
        ...
        <div className='flex flex-col px-4 py-2 gap-2'>
          ...
          <div className='flex flex-wrap gap-2'>
            <span className='flex py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>JavaScript</span>
            <span className='flex py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>React</span>
            <span className='flex py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>Tailwind CSS</span>
            <span className='flex py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>Context API</span>
            <span className='flex py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>Responsive</span>
          </div>
        ...
        className='flex flex-row mx-auto w-1/2 justify-center items-center p-2 gap-2 bg-zinc-900 hover:bg-zinc-950 rounded-md'>
      ...
      <div className='flex flex-col gap-2 pb-4 mb-4 w-full bg-gray-200 rounded-md border border-gray-300'>
        ...
        <div className='flex flex-col px-4 py-2 gap-2'>
          ...
          <div className='flex flex-wrap gap-2'>
            <span className='py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>JavaScript</span>
            <span className='py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>SPA</span>
            <span className='py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>Bootstrap</span>
            <span className='py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>API REST</span>
            <span className='flex py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>Responsive</span>
          </div>
          <p className='font-montse mb-4'>
      ...
      <div className='flex flex-col gap-2 pb-4 mb-4 w-full bg-gray-200 rounded-md border border-gray-300'>
        ...
        <div className='flex flex-col px-4 py-2 gap-2'>
          ...
          <div className='flex flex-wrap gap-2'>
            <span className='py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>JavaScript</span>
            <span className='py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>React</span>
            <span className='py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>Tailwind CSS</span>
            <span className='py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>API REST</span>
            <span className='flex py-0.5 px-1 bg-gray-300 text-sm font-medium font-montse rounded-md'>Responsive</span>
          </div>
          <p className='font-montse mb-4'>
      ...
      <div className='flex flex-col gap-2 pb-4 mb-4 w-full bg-gray-200 rounded-md border border-gray-300'>
        ...
        <div className='flex flex-col px-4 py-2 gap-2'>
          ...
          <p className='font-montse mb-4'>
            App que simula el feed de una red social, usando la API de <span className='font-bold'>thecatapi.com </span>
